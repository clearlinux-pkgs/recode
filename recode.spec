...
Source0  : https://github.com/rrthomas/recode/releases/download/v3.7.8/recode-3.7.8.tar.gz
...
%prep
%setup -q -n recode-3.7.8
cd %{_builddir}/recode-3.7.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605722560
...
cp %{_builddir}/recode-3.7.8/COPYING %{buildroot}/usr/share/package-licenses/recode/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/recode-3.7.8/COPYING-LIB %{buildroot}/usr/share/package-licenses/recode/f45ee1c765646813b442ca58de72e20a64a7ddba
%make_install
%find_lang recode
